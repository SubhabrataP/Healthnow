			...
			<div className="content">
		        <div className="row permissionheader">
		          <div className="col-md-12">
		            <h3 style={styles.textWhite}><strong>Departments</strong></h3>
		          </div>
		        </div>
        		<div className="row">
        			<div className="card">
        			  <div class="card-header">
					    <button type="button" className="btn buttonBg" data-toggle="modal" data-target="#deptModal">Add Department</button>
					  </div>
